; Note: Put your custom routine/data macros, references to them, and defines in this file from within the PM2_InsertIntegratedPatches and PM2_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro PM2_InsertIntegratedPatches()
...
macro PM2_ApplyPatchesPostAssembly()
