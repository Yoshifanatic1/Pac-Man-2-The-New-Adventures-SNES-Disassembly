...
echo Valid options: "PM2_U" "PM2_E" "PM2_J" "PM2_F" "PM2_G"
...
if "%Input1%" equ "PM2_U" goto :USA
if "%Input1%" equ "PM2_E" goto :PAL
if "%Input1%" equ "PM2_J" goto :Japan
if "%Input1%" equ "PM2_F" goto :French
if "%Input1%" equ "PM2_G" goto :German
...
:USA
set ROMVer=(U)
set ROMNAME=Pac-Man 2 - The New Adventures
goto :Assemble
